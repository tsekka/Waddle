...
var_dump(
    \Waddle\Converter::convertHumanReadableToSeconds(
        \Waddle\Converter::convertSecondsToHumanReadable($activity->getTotalDuration())
    )
);
...
var_dump(
    \Waddle\Calculators\CalorieCalculator::calculateCaloriesBurned(
        \Waddle\Calculators\CalorieCalculator::calculateMETFromMPH(6),
        75,
        \Waddle\Converter::convertHoursMinutesSecondsToDecimal(0, 23, 47)
    )
);
...
var_dump(
    \Waddle\Calculators\CalorieCalculator::calculateCaloriesBurned(
        \Waddle\Calculators\CalorieCalculator::calculateMETFromKMPH(15.6),
        90,
        \Waddle\Converter::convertHoursMinutesSecondsToDecimal(1, 21, 5)
    )
);
